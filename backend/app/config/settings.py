...
class Settings(BaseSettings):
    ...
    cost_global_daily_tokens: int = Field(500000, alias="COST_GLOBAL_DAILY_TOKENS")
    cost_ip_window_seconds: int = Field(3600, alias="COST_IP_WINDOW_SECONDS")
    cost_ip_window_tokens: int = Field(20000, alias="COST_IP_WINDOW_TOKENS")
    cost_actor_daily_tokens: int = Field(50000, alias="COST_ACTOR_DAILY_TOKENS")
    cost_request_max_tokens: int = Field(6000, alias="COST_REQUEST_MAX_TOKENS")
    cost_request_max_output_tokens: int = Field(1200, alias="COST_REQUEST_MAX_OUTPUT_TOKENS")
    cost_breaker_fail_threshold: int = Field(5, alias="COST_BREAKER_FAIL_THRESHOLD")
    cost_breaker_window_seconds: int = Field(60, alias="COST_BREAKER_WINDOW_SECONDS")
    cost_breaker_cooldown_seconds: int = Field(120, alias="COST_BREAKER_COOLDOWN_SECONDS")
    cost_events_ring_size: int = Field(500, alias="COST_EVENTS_RING_SIZE")
    cost_log_level: str = Field("INFO", alias="COST_LOG_LEVEL")
